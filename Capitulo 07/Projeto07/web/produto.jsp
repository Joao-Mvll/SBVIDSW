...
<div class="container">
    ...
    <div class="lado-esquerdo">
        <div class="card">
            <p style="font-size: 20px; font-weight: 800; color: rgb(26, 26, 26);">Produtos</p>
            <p style="text-align: center; font-size: 0.7em; font-weight: 600; color: rgb(99, 99, 99);">
                Adicione um Produto para mostrar a listagem
            </p>
    ...
    <div class="lado-direito">
        <div id="exemploProduto" class="exemploDIV" style="width: 1000px; height: 500px;"></div>
    </div>
