                        ...
                        <div class="container py-5">
                            <div class="row justify-content-center">
                                ...
                                <div class="col-md-4 mb-4">
                                    <a href="${cp}/formularios/ator/novo.jsp" class="btn btn-lg btn-light w-100 text-center border shadow" style="border-radius: 10px;">
                                ...
                                <div class="col-md-4 mb-4">
                                    <a href="${cp}/formularios/ator/listagem.jsp" class="btn btn-lg btn-light w-100 text-center border shadow" style="border-radius: 10px;">
