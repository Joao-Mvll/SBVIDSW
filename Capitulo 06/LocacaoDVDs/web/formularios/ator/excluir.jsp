            ...
            <div class="col-md-8 col-lg-6">
                <form method="post" action="${cp}/processaAtor" class="mb-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nome" placeholder="Digite o nome" value="${requestScope.ator.nome}" required disabled >
                    </div>

                    
                    <div class="form-group">
                        <label for="sobrenome">Sobrenome</label>
                        <input type="text" class="form-control" name="sobrenome" placeholder="Digite o sobrenome" value="${requestScope.ator.sobrenome}" required disabled>
                    </div>

                    
                    <div class="form-group">
                        <label for="dataEstreia">Data de Estreia</label>
                        <input type="date" class="form-control" name="data_estreia" value="${requestScope.ator.data_estreia}" required disabled>
                    </div>
