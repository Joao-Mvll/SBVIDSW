            ...
            <div class="col-md-8 col-lg-6">
                <form method="post" action="${cp}/processaDvd" class="mb-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="titulo" placeholder="Digite o título" value="${requestScope.dvd.titulo}" required disabled>
                    </div>

                    <div class="form-group">
                        <label for="anoLancamento">Ano de Lançamento</label>
                        <input type="number" class="form-control" name="anoLancamento" placeholder="Digite o ano de lançamento" value="${requestScope.dvd.ano_lancamento}" required disabled>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="idAtorPrincipal" class="form-control" value="${requestScope.dvd.ator_principal}" required disabled>
                    ...
                    <div class="form-group">
                        ...
                        <select name="idAtorCoadjuvante" class="form-control" value="${requestScope.dvd.ator_coadjuvante}" required disabled>
                            <c:forEach items="${servicosAtor.getTodos()}" var="ator">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="dataLancamento" placeholder="Digite a data de lançamento" value="${requestScope.dvd.data_lancamento}"  required disabled>
                    </div>

                    <div class="form-group">
                        <label for="duracao">Duração (em minutos)</label>
                        <input type="number" class="form-control" name="duracao" placeholder="Digite a duração em minutos" value="${requestScope.dvd.duracao_minutos}" required disabled>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="idClassificacao" class="form-control" value="${requestScope.dvd.classificacao}" required disabled>
                    ...
                    <div class="form-group">
                        ...
                        <select name="idGenero" class="form-control" value="${requestScope.dvd.genero}" required disabled>
