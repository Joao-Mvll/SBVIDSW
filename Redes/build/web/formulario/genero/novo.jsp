...
<html>
    ...
    <body>
        <p>Gerencie seus gêneros de forma eficiente.</p>
        <!-- Novo Gênero Formulário -->
        <div class="form-container">
            ...
            <form method="post" action="${cp}/processaGenero">
                ...
                <div class="button-container-inline">
                    <button type="button" onclick="window.location.href = '${cp}/formulario/genero/listagem.jsp'" class="button-secondary">Voltar</button>
